...
- ML Monday -- I'm including AI within ML, so this could be anything from the fundamentals of ML (regression, etc.) to LLM workflows with LangChain, to cloud APIs for computer vision, etc.
